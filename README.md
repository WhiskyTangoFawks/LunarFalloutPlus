...
From the author of Creative Perks Plus, a Fallout 4 for a moderate difficulty survival playthrough based on Lunar Fallout Overhaul, with a ton of extra spice.
...
- A vibrant, inhabited, but still uncivilized wasteland. Neglected areas should feel fleshed out, and Diamond City should really feel like the "Jewel of the Commonwealth"
...
- an "everything but the kitchen sink" list with every mod out there - if you want that, go play Magnum Opus or [MOFAM](https://www.nexusmods.com/fallout4/mods/48580)
...
5. (Optional) If you want vault suits to appear in more colors than the standard blue, disable `OnlyBlueVaultsuits.esp` (this adds them to the spawn list, you can still change the color at a workbench with or without it)
...
3. Backpacks of the Commonwealth - When you exit Vault 111, this will inject backpacks into the leveled lists. Select your chosen distribution when it comes up. I like backpacks being completely unique, but whatever you want.
...
- Mods that were removed in the Great Nexus Purge and are no longer available : Utility Belt, Better Cooking Stations (v1), MsRae's Commonwealth Interiors, Swinging Animated Meatbags. All of these are compatible, and don't need patching. Feel free to add them if you have them. Please note that I cannot give them to you, and you can't ask for them. That is mod piracy.
...
1. Lunar Fallout Overhaul has a specific balance. Adding new weapons, armors, monsters, or items is NOT RECOMMENDED. It probably won't break it, but it will screw with the balance. If you want to patch it in, information how the mod works and its balance can be found on Moonracer's Lunar Fallout Overhaul mod page.
...
3. As stated above, the AWKCR plugin in this list is NOT the normal AWKCR. You should not need to worry about AWKCR compatibility with anything added, unless you want to add faction based omod distribution via Gunmetal Faction Distribution Framework.
